...
comparisons. “Existing” denotes the original one-method scripts, which assert inline; “structured”
denotes the scripts that store their outputs for `evaluate.py` to compare and score.
...
| Scanpy tools                         | `leiden`, `umap`                                                                                                                                                                                                        | Existing one-method scripts, unchanged by this suite                      |
...
runs anywhere, including against a committed snapshot.
